...
import NotificationMenu from "@/features/notifications/components/NotificationMenu/NotificationBadge";
...
const Navbar: React.FC<NavbarProps> = ({ 
    ...
    return (
        <nav className={`flex flex-wrap sm:flex-none py-1 sm:pl-10 sm:pr-10 pl-1 pr-1 bg-[var(--third-bg-color)] gap-3
            ${className}
            ...
            {isAuthenticated ?
                ...
                <div className="flex gap-2">
                    <Button size="sm-1" variant="secondary" onClick={() => onLogin?.()}>Sign in</Button>
                    <Button size="sm-1" variant="primary" onClick={() => onSignup?.()}>Sign up</Button>
                </div>
            }
        </nav>
    )
