...
const NavbarItem: React.FC<NavbarItemProps> = ({ children, path, className = "", onClick }) => {
  const isFocused = useActiveRoute(path, true);

  return (
    <Link
      className={`${className} relative flex items-center justify-center !text-[15px] whitespace-nowrap
