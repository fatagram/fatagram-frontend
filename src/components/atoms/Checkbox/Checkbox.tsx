...
const Checkbox: React.FC<CheckboxProps> = ({
    ...
    return (    
        <label className={`relative inline-flex items-start gap-[0.1rem] select-none checkbox ${className || ''}`}>
            <input 
                {...props}
                disabled={disabled} 
                type='checkbox' 
            ...
            />
            <span className={`absolute z-[2] rounded-[4px] m-[3px] w-[18px] h-[18px] ${styles["checkmark"]} bg-gradient-main
