  ...
  return (
    <div className="relative min-h-[calc(100dvh-var(--header-height))] w-full overflow-hidden bg-bg-main flex flex-col items-center justify-center pt-20">
      ...
      <div className="absolute top-0 left-0 w-full h-[calc(100%-450px)] z-0 overflow-hidden pointer-events-none hidden md:block">
        <div className="absolute top-[10%] left-[8%] opacity-0 animate-pop-in" style={{ animationDelay: "0.2s" }}>
          <img 
        ...
        <div className="absolute bottom-[10%] right-[8%] opacity-0 animate-pop-in" style={{ animationDelay: "0.4s" }}>
          <img 
        ...
        <div className="absolute top-[15%] right-[12%] opacity-0 animate-pop-in" style={{ animationDelay: "0.6s" }}>
          <img 
        ...
        <div className="absolute bottom-[15%] left-[12%] opacity-0 animate-pop-in" style={{ animationDelay: "0.8s" }}>
          <img 
      ...
      <div className="relative z-10 max-w-5xl w-full px-6 flex flex-col items-center gap-10 text-center flex-1 pb-20">
        ...
        <div className="flex flex-col items-center gap-6 opacity-0 animate-pop-in">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-text-main leading-[1.15]">
            {t("hero.title1")} <span className="text-gradient-main">{t("hero.title2")}</span><br/>
            {t("hero.title3")} <span className="text-gradient-second">{t("hero.title4")}</span>
          </h1>
          
          <Text sz="lg" wrap="whitespace-normal" className="max-w-2xl text-text-second leading-relaxed mt-2 backdrop-blur-md bg-bg-main/50 p-5 rounded-3xl border border-bg-third shadow-sm">
            {t("hero.subtitle")}
          </Text>
        </div>

        {/* Action Buttons */}
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mt-4 opacity-0 animate-pop-in" style={{ animationDelay: "0.3s" }}>
          <Button 
            sz="xl" 
            variant="primary" 
          ...
          >
            ...
            <i className="fa-solid fa-arrow-right ml-3 group-hover:translate-x-1 transition-transform" />
          </Button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mt-12 opacity-0 animate-pop-in" style={{ animationDelay: "0.5s" }}>
          {[
            { icon: "fa-bolt", title: t("features.speed.title"), desc: t("features.speed.desc") },
            { icon: "fa-shield-halved", title: t("features.security.title"), desc: t("features.security.desc") },
            { icon: "fa-wand-magic-sparkles", title: t("features.ui.title"), desc: t("features.ui.desc") }
          ].map((feature, i) => (
            <div 
              key={i}
              className={clsx(
