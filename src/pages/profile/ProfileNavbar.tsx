...
const ProfileNavbar: React.FC<ProfileNavbarProps> = ({
    ...
    return (
        <div className={`relative flex ${className}`} ref={containerRef}>
            ...
            {hiddenItems.length > 0 && <Button variant="secondary" className={`relative overflow-hidden
            ...
            { showDropdown && 
                (
                    <Dropdown className="absolute z-[9997] top-[100%] m-0 bg-[var(--main-bg-color)] shadow-lg rounded-md
