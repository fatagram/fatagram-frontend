...
function RegisterPage() {
  ...
  return (
    ...
    >
      <div
        className="relative w-full flex justify-center lg:justify-between m-2 z-10 backdrop-blur-sm bg-[var(--second-bg-color)]
                lg:max-w-[75%] max-w-[95%] rounded-lg overflow-hidden sm:h-[95vh] h-auto"
      >
        <div
          className="hidden relative sm:flex flex-col register-bg w-full rounded-lg h-full items-center justify-center gap-1
